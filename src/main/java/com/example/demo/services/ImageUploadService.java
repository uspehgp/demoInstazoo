...
import com.example.demo.exceptions.NotFoundImageExeption;
...
public class ImageUploadService {
    ...
    public ImageModel uploadImageToUser(MultipartFile file, Principal principal) throws IOException {
        ...
        ImageModel userProfileImage = imageRepository.findByPostId(user.getId()).orElse(null);
    ...
    public ImageModel getImageToPost(Long postId) {
        ImageModel imageModel = imageRepository.findByPostId(postId).orElseThrow(
                () -> new NotFoundImageExeption("Can't find image to post " + postId));
        if (!ObjectUtils.isEmpty(imageModel)) {
            imageModel.setImageBytes(decompressBytes(imageModel.getImageBytes()));
        }
        return imageModel;
